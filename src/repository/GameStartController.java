...
public class GameStartController implements Initializable {
    ...
    public static Button[][] button_array = new Button[5][9];
    public static String[][] color_array = new String[5][9];
    ...
    private void handleButtonAction(ActionEvent event) throws IOException {
        ...
        if (TownController.enteredTown) {
            String color = color_array[0][0];
            b.setStyle("-fx-base: " + color + "; -fx-text-fill: white;");
